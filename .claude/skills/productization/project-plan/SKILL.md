...
### Step 5: Point the user to the plan

> "Plan imported: {N} deliverables across 6 sprints. View it in the Projects tab at
> http://localhost:3001 — deliverables are grouped by month with priority and team
> workload."

### Step 6: (Optional) Export to a PM tool
...
First sprint activated. View in dashboard at http://localhost:3001
```
