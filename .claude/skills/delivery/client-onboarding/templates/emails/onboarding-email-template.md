...
- {{access_checklist_link}}      — Customized Access Checklist doc URL (omit if missing)
- {{scheduling_link}}            — Booking link, sourced from agency.calendar_link
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 1.6; color: #1f2937; max-width: 640px; margin: 0 auto; padding: 24px; background: #ffffff;">
  ...
  <p style="font-size: 16px;">Before we can audit and optimize, we need access to a few platforms. Please open the access checklist and follow each step:</p>
  <p style="font-size: 16px;"><a href="{{access_checklist_link}}" style="color: {{primary_color}};">Open Access Checklist</a></p>
  <p style="font-size: 16px;">The checklist covers:</p>
  <ul style="font-size: 16px;">
    <li>Google Search Console</li>
    <li>Google Analytics 4</li>
    <li>Google Business Profile</li>
    <li>Google Tag Manager</li>
    <li>Google Ads / LSA (if applicable)</li>
    <li>Website CMS access</li>
    <li>Citation profile credentials (Yelp, Avvo, Justia, FindLaw, etc.)</li>
  </ul>
...
- If {{access_checklist_link}} is empty, omit Step 1 entirely.
- If {{scheduling_link}} is empty (agency.calendar_link not set), omit Step 2 entirely.
